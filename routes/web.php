...
Route::get('/vulnerabilities/count', [DashboardController::class, 'getVulnerabilityCountByRegion'])->name('vulnerability.count');
Route::get('/vulnerabilities/exploit-yes', [DashboardController::class, 'getVulnerabilityCountByRegionWithExploitYes'])->name('getVulnerabilityCountByRegionWithExploitYes');
    Route::post('/document-compliance-audit-standard', [DashboardController::class, 'documentComplianceAllStandardsAudit'])->name('document.compliance.auditpolicy.result');
    Route::post('/document-compliance-audit-standard-policy-clause', [DashboardController::class, 'documentComplianceAllStandardsAuditForClause'])->name('document.compliance.auditpolicy.resultPolicyClause');
 
    Route::get('/document-compliance-audit-result', [DashboardController::class, 'documentComplianceAudit'])->name('document.compliance.audit.result');
...
// Route::group([
//     'middleware' => ['web', 'MsGraphAuthenticated', 'msgraph.user'],
//     'prefix' => 'app'
// ], function(){
