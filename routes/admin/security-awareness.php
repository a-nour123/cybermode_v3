...
Route::group([
    ...
    Route::get('exam/{id}', [App\Http\Controllers\admin\security_awareness\SecurityAwarenessExamController::class, 'SecurityAwarenessOutSide'])->name('admin.security_awareness.SecurityAwarenessOutSide')->withoutMiddleware('auth');
    Route::post('/takeExamFromOutSideCyber', [App\Http\Controllers\admin\security_awareness\SecurityAwarenessExamController::class, 'takeExamFromOutSideCyber'])->name('takeExamFromOutSideCyber')->withoutMiddleware('auth');
});
