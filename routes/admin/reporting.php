...
Route::group(
    ...
    function () {
        ...
        Route::get('/framewrok-control-compliance-numbertest/{id}', [FrameWorkControllerReportingController::class, 'auditTestNumber'])->name('auditTestNumber');
        ...
        Route::get('/requirements', [ObjectiveReportingController::class, 'index'])->name('objectives');
        Route::get('/get-framwork-controls/{id}', [ObjectiveReportingController::class, 'getFrameworkControls'])->name('getFrameworkControls');
