...
Route::group(
    ...
    function () {
        ...
        Route::get('/configuretion', [AssetManagementController::class, 'configure'])->name('configuretion');
        Route::get('/import', [AssetController::class, 'openImportForm'])->name('import');
        Route::get('/import-groups', [AssetGroupController::class, 'openImportForm'])->name('importGroups');
        Route::get('admin/asset_management/ajax/assets', [AssetGroupController::class, 'getAssets'])->name('ajax.assets');
        Route::get('admin/asset-management/download-export/{filename?}', [AssetController::class, 'downloadExportedFile'])->name('download.export');
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('/index/asset', [AssetController::class, 'assetStatistics'])->name('statistics.asset');
                ...
                Route::post('/comment-asset', [AssetController::class, 'sendAssetComment'])->name('sendComment');
                Route::get('/download-comment-file-asset/{id}', [AssetController::class, 'downloadAssetCommentFile'])->name('downloadCommentFile');
                Route::delete('/clear-cooments-asset/{id}', [AssetController::class, 'clearComments'])->name('clearComments');
                Route::get('/get-comments/{id}', [AssetController::class, 'showAssetComments'])->name('showComments');
