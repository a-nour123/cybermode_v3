...
Route::group(['prefix' => 'awarness-survey', 'middleware' => 'auth','as' => 'awarness_survey.'
    ...
    Route::get('GetSurveyFromMail/{id}', [App\Http\Controllers\admin\security_awareness\AnswerQuestionSurveyController::class, 'GetSurveyFromMail'])->name('GetSurveyFromMail');
