    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('/kpi/{id}', [KpiController::class, 'KpiType'])->name('type');
                Route::get('/kpi/assessment/{id}', [KpiController::class, 'KpiTypeAssessment'])->name('typeAssessment');
                ...
                Route::get('/get-users', [KPIController::class, 'getUsersByDepartment'])->name('get.users');
                Route::post('/store-users-assigned', [KPIController::class, 'StoreAssignedUser'])->name('StoreAssignedUser');
