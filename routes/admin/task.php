...
Route::group(
    ...
    function () {
        ...
        Route::post('/store_Category', [TaskController::class, 'storeCategory'])->name('storeCategory');
        Route::get('/next-doc-page', [TaskController::class, 'NexDocPage']);
        Route::get('/prev-doc-page', [TaskController::class, 'PrevDocPage']);
        Route::post('/catgeory-delete', [TaskController::class, 'deleteCategory'])->name('deleteCategory');
        Route::post('/update-category', [TaskController::class, 'updateCategory'])->name('updateCategory');
        Route::get('/edit-task-category/{id}', [TaskController::class, 'getCategoryDetails'])->name('EditCategory');
        Route::post('/admin/task/copy/{id}', [TaskController::class, 'CopyTask'])->name('CopyTask');
