    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('/get-framework-controls', [ControlObjectiveController::class, 'getFrameworkControls'])->name('getFrameworkControls');
                Route::get('/get-controls', [ControlObjectiveController::class, 'getControls'])->name('getControls');
