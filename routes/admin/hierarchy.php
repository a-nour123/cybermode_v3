...
Route::group(
    ...
    function () {
        ...
        Route::group([
            ...
            Route::get('/import-ldap', [DepartmentController::class, 'openImportLdap'])->name('ldapImport');
            Route::post('/import-ldap', [DepartmentController::class, 'saveImportLdap'])->name('import.ldap.store');
            Route::get('/configuretion', [DepartmentController::class, 'configure'])->name('configuretion');
