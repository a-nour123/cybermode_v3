...
use App\Http\Controllers\admin\risk_management\RiskStatisticsController;
...
Route::group(
    ...
    function () {
        ...
        Route::get('/configuretion', [RiskManagementController::class, 'configure'])->name('configuretion');
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('/export-pdf', [RiskManagementController::class, 'exportDataPdf'])->name('exportDataPdf');

                Route::get('/index/statistics', [RiskStatisticsController::class, 'index'])->name('statistics.risk');
